...
CONFIGS = _load(
    ...
    ROOT / "tools" / "evaluation" / "build_openloris_loop_sweep_configs.py",
)
COMPARE = _load(
    "compare_openloris_loop_sweep",
    ROOT / "tools" / "evaluation" / "compare_openloris_loop_sweep.py",
)
COMPACT = _load(
    "compact_openloris_rosbag",
    ROOT / "tools" / "evaluation" / "compact_openloris_rosbag.py",
)
