...
grep -q "openloris-rosbag-setup" <<<"$OUTPUT"
grep -q "openloris-replay-stage" <<<"$OUTPUT"
grep -q "openloris-scan-overlap-ablation" <<<"$OUTPUT"
grep -q "lidar-loop-runtime" <<<"$OUTPUT"
...
grep -q "runtime-evidence-summary" <<<"$OUTPUT"
grep -q "wsl-microphone-preflight" <<<"$OUTPUT"
grep -q "cpp-action-client" <<<"$OUTPUT"
grep -q "cpp-action-bridge-lifecycle" <<<"$OUTPUT"
