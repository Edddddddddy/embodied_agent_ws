#!/usr/bin/env python3
"""Verify keyword_wake openWakeWord mode bridges audio frames to wake events."""
...
class OpenWakeWordProbe(Node):
    def __init__(self):
        super().__init__("openwakeword_probe")
