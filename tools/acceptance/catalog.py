...
_MODE_SPECS = (
    ('verify', '{core|voice|control|gazebo|slam-nav|all} Unified key-feature gate; no live microphone', 'accept_verify', 'public', True, True, HandlerDomain.CONTROL),
    ('core', 'Typical developer gate: repository, Python unit, C++ unit tests', 'accept_core', 'internal', False, True, HandlerDomain.CONTROL),
    ...
    ('nav2-stage', 'Stage gate for voice navigation/patrol; excludes heavy Gazebo/Nav2', 'accept_nav2_stage', 'internal', False, True, HandlerDomain.SLAM_NAV),
    ...
    ('slam-nav-e2e', 'Known-world deterministic SLAM/Nav2 regression (legacy stable entry)', 'accept_slam_nav_e2e', 'internal', False, True, HandlerDomain.SLAM_NAV),
    ('unknown-world-slam-e2e', 'Unknown-world autonomous exploration -> SLAM -> AMCL/Nav2 evidence gate', 'accept_unknown_world_slam_e2e', 'internal', False, True, HandlerDomain.SLAM_NAV),
    ('voice-unknown-world-slam-e2e', '{offline|online} Live microphone -> full-evidence unknown-world SLAM/Nav2 gate', 'accept_voice_unknown_world_slam_e2e', 'interactive', False, True, HandlerDomain.SLAM_NAV),
    ...
    ('robotics-gate', 'Unified ROS/Nav2/SLAM/dynamic-obstacle evidence gate', 'accept_robotics_gate', 'internal', False, True, HandlerDomain.CONTROL),
    ...
    ('gazebo', 'Typed Action physical motion verification', 'accept_gazebo', 'internal', False, True, HandlerDomain.CONTROL),
    ...
    ('continuous-offline', 'Long-running microphone control using the offline Agent', 'accept_continuous_offline', 'interactive', False, True, HandlerDomain.VOICE),
    ('continuous-online', 'Long-running microphone control using the online Agent', 'accept_continuous_online', 'interactive', False, True, HandlerDomain.VOICE),
