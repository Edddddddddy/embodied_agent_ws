...
- 启动契约：在线/离线 launch 复用 `agent_launch_contract.py` 与 `voice_frontend_launch_contract.py`；前者管理 Agent 控制面，后者统一音频、VAD、KWS、声纹参数及节点装配，provider launch 只保留自身模型/TTS/硬件编排。
