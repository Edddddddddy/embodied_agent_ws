...
if ! timeout 360 python3 tests/integration/test_voice_slam_session_orchestrator.py \
...
if ! timeout 420 python3 tests/integration/test_nav2_turtlebot3_voice.py \
