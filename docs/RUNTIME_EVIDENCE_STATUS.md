...
| 扫描重叠跨序列 | corridor1-1 双证据 ATE 改善 5.84%；corridor1-2 四组 ATE 均 0.1538 m、收益为 0；两图 SHA256 独立且证据完整 | **已测但不启用**，平均改善 2.92% 不能掩盖第二序列无收益，发布决策为 `keep_disabled_collect_more_sequences` |
