...
- SHA256：`6f9d819a0384bf5a3356980c003c9d2bc3af23fb918ea6293b0a090e5aaf342f`
- 图规模：488 nodes / 491 constraints
- 每组匹配位姿：488
- ATE 最优组：**cauchy_baseline**
- 公平性检查：**PASS**
- 原始扫描证据：1 条非局部边，unavailable=0
- 重叠率分布：min=0.8561 / median=0.8561 / P95=0.8561 / max=0.8561
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| cauchy_baseline | False | False | 0.65 | 1.0 | 491 | 0 | 0 | 0.1538 | 0.2769 | 0.0641 | 0.4316 | +0.00% |
| naive_overlap | False | True | 0.65 | 0.0 | 491 | 0 | 0 | 0.1538 | 0.2769 | 0.0641 | 0.4316 | +0.00% |
| innovation_gate | True | False | 0.65 | 1.0 | 491 | 0 | 0 | 0.1538 | 0.2769 | 0.0641 | 0.4316 | +0.00% |
| dual_evidence | True | True | 0.65 | 1.0 | 491 | 0 | 0 | 0.1538 | 0.2769 | 0.0641 | 0.4316 | +0.00% |
